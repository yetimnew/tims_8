            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <a href="{{route('job_ident.create')}}" class="btn btn-outline-primary"><i
                            class="fa fa-plus mr-1"></i>Add Job Ident Type</a>
                ...
                <table class="table-sm table table-bordered table-sm table-striped" id="job_ident">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class='p-1 text-center'>{{$jobident->mechanic_hours}}</td>
                            <td class='p-1 text-center'>{{$jobident->ass_mechanic_hours}}</td>
                            <td class='p-1 text-center'>{{$jobident->comments}}</td>


                            {{-- @can('driver edit') --}}
                            <td class='p-1 text-center' data-toggle="tooltip" data-placement="top" title="details">
                                <a href="{{route('job_ident.edit', $jobident->id)}}"><i class="fa fa-edit "></i></i></a>
                            </td>
                            <td class='p-1 text-center' data-toggle="tooltip" data-placement="top" title="details">
