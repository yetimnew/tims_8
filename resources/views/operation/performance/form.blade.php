<div class="row">
    <div class="col-md-6">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group required">
                    ...
                    <select name="load_type" class="form-control select  {{ $errors->has('load_type') ? ' is-invalid' : '' }}"
                        id="load_type" onfocusout="validateload_type()">
        ...
        <div class="form-group required">
            ...
            <div class="input-group">
                <input name="fo_number" type="text" required class="form-control {{ $errors->has('fo_number') ? ' is-invalid' : '' }}"
                    id="fo_number" placeholder="Fright order number" value="{{ old('fo_number') ?? $performance->fo_number }}"
        ...
        <div class="form-group required">
            ...
            <select name="operation_id" class="form-control {{ $errors->has('operation_id') ? ' is-invalid' : '' }} select"
                id="operation_id" value="" onfocusout="validateOperation()">
                <option class="dropup" value=""> Select One</option>
                @foreach ($operations as $operation)
                    @if (old('operation_id') )
                      <option class="dropup"  value="{{$operation->id}}" {{old('operation_id') == $operation->id ? 'selected' : ''}}> {{$operation->operationid}} </option>
                    @else
                       <option value={{$operation->id}}  {{$operation->id == $performance->operation_id ? 'selected' : ''}}>{{$operation->operationid }}</option>
                    @endif
                @endforeach
            </select>
        ...
        <div class="form-group required">
            ...
            <select name="driver_truck_id" class="form-control {{ $errors->has('driver_truck_id') ? ' is-invalid' : '' }} select" id="driver_truck_id"
                onfocusout="validateTruck()">
                <option class="dropup" value=""> Select One</option>
                @foreach ($driver_truck as $dt)
                @if (old('driver_truck_id') )
                   <option class="dropup"  value="{{$dt->id}}" {{old('driver_truck_id') == $dt->id ? 'selected' : ''}}>  {{$dt->Name}} -  {{$dt->Plate}}</option>
                @else
                   <option value={{$dt->id}}  {{$dt->id == $performance->driver_truck_id ? 'selected' : ''}}>  {{$dt->Name}} -  {{$dt->Plate}}</option>
                @endif
                @endforeach
            </select>
        ...
        <div class="form-group required">
            ...
            <div class="input-group">
                <input name="date_dispatch" type="text" class="form-control {{ $errors->has('date_dispatch') ? ' is-invalid' : '' }}"
                    id="date_dispatch" value="{{ old('date_dispatch' ) ?? $performance->date_dispatch}}" onfocusout="validatedate_dispatch()">
        ...
        <div class="form-group required">
            ...
            <select name="origin_id"
                class="form-control{{ $errors->has('origin_id') ? ' is-invalid' : '' }} select origin_place" id="origin_id"
                onfocusout="validateorigin_id()">
                <option class="dropup"> </option>
                @foreach ($place as $pl)
                    @if (old('origin_id') )
                        <option class="dropup"  value="{{$pl->id}}" {{old('origin_id') == $pl->id ? 'selected' : ''}}>  {{$pl->name}} </option>
                    @else
                      <option value="{{$pl->id}}"  {{$pl->id == $performance->origin_id ? 'selected' : ''}}>  {{$pl->name}} </option>
                    @endif
                @endforeach
            </select>
            ...
            <select name="destination_id"
                ...
                @foreach ($place as $pl)
                    @if (old('destination_id') )
                        <option class="dropup"  value="{{$pl->id}}" {{old('destination_id') == $pl->id ? 'selected' : ''}}>  {{$pl->name}} </option>
                    @else
                    <option value="{{$pl->id}}"  {{$pl->id == $performance->destination_id ? 'selected' : ''}}>  {{$pl->name}} </option>
                    @endif
            @endforeach
            </select>
        ...
        <div class="form-group required">
            ...
            <div class="input-group">
                <input name="distance_without_cargo" type="number"
                    class="form-control {{ $errors->has('distance_without_cargo') ? ' is-invalid' : '' }}" id="distance_without_cargo"
                    value="{{ old('distance_without_cargo') ?? $performance->distance_without_cargo}}" min="1" onfocusout="validatedistance_without_cargo()">
            ...
            <div class="input-group">
                <input name="distance_with_cargo" type="number" class="form-control {{ $errors->has('distance_with_cargo') ? ' is-invalid' : '' }}"
                    id="distance_with_cargo" value="{{ old('distance_with_cargo') ?? $performance->distance_with_cargo}}" min="1"
        ...
        <div class="form-group required">
            ...
            <div class="input-group">
                <input name="tone" type="number"
                    class="form-control {{ $errors->has('tone') ? ' is-invalid' : '' }}" id="tone"
                    value="{{ old('tone') ?? $performance->tone}}" min="1" onfocusout="validatetone()">
                @if($errors->has('tone'))
                <span class="invalid-feedback" role="alert">
        ...
        <div class="form-group required">
            ...
            <div class="input-group">
                <input name="ton_km" type="number" class="form-control {{ $errors->has('ton_km') ? ' is-invalid' : '' }}"
                    id="ton_km" value="{{ old('ton_km') ?? $performance->ton_km}}" min="1" onfocusout="calculatedton_km()">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input name="fuelIn_litter" type="number" class="form-control {{ $errors->has('fuelIn_litter') ? ' is-invalid' : '' }}"
                    id="fuelIn_litter" value="{{ old('fuelIn_litter') ?? $performance->fuelIn_litter}}" min="1"
        ...
        <div class="form-group ">
            ...
            <div class="input-group">
                <input name="fuelIn_birr" type="number" class="form-control{{ $errors->has('fuelIn_birr') ? ' is-invalid' : '' }}"
                    id="fuelIn_birr" value="{{ old('fuelIn_birr') ?? $performance->fuelIn_birr}}" min="1"
        ...
        <div class="form-group ">
            ...
            <div class="input-group">
                <input name="operational_expense" type="number" class="form-control {{ $errors->has('operational_expense') ? ' is-invalid' : '' }}"
                    id="operational_expense" value="{{ old('operational_expense') ?? $performance->operational_expense}}" min="1" onfocusout="validateoperational_expense()">
        ...
        <div class="form-group ">
            <label class="control-label" for="other_expense"> other_expense Expences</label>
            <div class="input-group">
                <input name="other_expense" type="number" class="form-control {{ $errors->has('other_expense') ? ' is-invalid' : '' }}"
                    id="other_expense" value="{{ old('other_expense') ?? $performance->other_expense}}" min="1" onfocusout="validatother_expense()">
