...
<div class="col-md-12">
    ...
    <div class="card text-left">
        ...
        <div class="card-body">
            <form method="post" action="{{route('operation.update',$operation->id)}}" class="form-horizontal"
                id="operation_reg_form">
                @method('PATCH')
                @csrf
                @include('operation.operation.form')
                <input name="created_by" type="hidden" id="created_by" value="{{$operation->created_by}}">
