<div class="row">
    <div class="col-6">
        ...
        <div class="form-group 	required">
            <label class="control-label" for="start_date">መነሻ ቀን</label>
            <div class="input-group-sm">
    ...
    <div class="col-6">
        <div class="form-group 	required">
            <label class="control-label" for="end_date">የሚያልቅበት ቀን</label>
            <div class="input-group-sm">
        ...
        <div class="form-group ">
            ...
            <div class="input-group">
                <textarea name="note" rows="5" class="form-control {{ $errors->has('note') ? ' is-invalid' : '' }}"
